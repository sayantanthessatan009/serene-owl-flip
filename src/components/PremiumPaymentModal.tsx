...
const PremiumPaymentModal = ({ isOpen, onClose }: PremiumPaymentModalProps) => {
  const steps = [
    ...
    "Enter amount: ₹8,500",
    "Add note: Premium Plan Advance - LUXTEXC",
    "Tap Pay & confirm"
  ];
          ...
          <div className="space-y-8">
            ...
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10 space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-medium text-platinum">₹41,500</span>
              </div>
            ...
            <div className="flex items-start gap-3 p-4 rounded-xl bg-white/5 border border-white/5">
              ...
              <p className="text-[10px] text-platinum/40 leading-relaxed uppercase tracking-wider">
                This advance secures your Premium Plan booking. Remaining ₹41,500 due before project start.
              </p>
            </div>
