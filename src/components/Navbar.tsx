...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isScrolled ? 'py-4 bg-luxx-black/80 backdrop-blur-lg border-b border-white/5' : 'py-8 bg-transparent'}`}>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-luxx-black border-b border-white/10 overflow-hidden"
          >
